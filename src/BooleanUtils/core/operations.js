...
// let totalTriangleA = 0
// let totalTriangleB = 0
...
export function performOperation(
	...
	// totalTriangleA += aIntersections.ids.length
	// totalTriangleB += bIntersections.ids.length
...
function performWholeTriangleOperations(
	...
	while (traverseSet.size > 0) {
		...
		while (stack.length > 0) {
			...
			const groupIndex =
				groupOffset === -1 ? 0 : groupIndices[currId] + groupOffset;
			const attrSet = attributeInfo.getGroupSet(groupIndex);
